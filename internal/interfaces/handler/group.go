...
func (handler *GroupHandler) Join(ctx *network.Context) (response interface{}, err error) {
...
func (handler *GroupHandler) Leave(ctx *network.Context) (response interface{}, err error)  {
